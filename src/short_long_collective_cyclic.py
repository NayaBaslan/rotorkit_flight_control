...
# Model using only collective pitch control
...
short_blades.name = "short_blades"
...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.grid()
    #plt.savefig("figs/model_long_blades.png")
    ...
    plt.grid()
    plt.show()
    #plt.savefig("figs/model_short_blades.png")
