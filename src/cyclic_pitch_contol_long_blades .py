# This code is for modeling both cyclic and collective pitch control for short blades
# Calculations are done for all 3 blades
...
r_0 = 0.05 #initial radius element
#ui = (inflow velocity)
# beta
collective_pitch = 16#pitch angle inital value
